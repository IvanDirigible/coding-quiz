...
var qList = document.querySelector(".multi-choice");
var arr = ["strings", "booleans", "alerts", "numbers"];
var beginEl = document.querySelector(".begin-btn");

function generateQ(el, arr){
    for (let i = 0; i < arr.length; i++){
        qGen = body.createElement('button');
        qGen.textContent = arr[i];
        el.appendChild(qGen);
    }
    console.log("Did this iterate?")
    return el
};

if (beginEl) {
    beginEl.addEventListener("click", generateQ)
